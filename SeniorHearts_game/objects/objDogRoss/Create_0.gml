...
firstDialogue[3] = "I'm hanging in there. Thanks for asking. It's hard as always, but we'll get through it.";
firstDialogue[4] = "Enough about me, though. How are you taking the news?";
...
secondDialogue2[0] = "Oh music is nice. Music has never helped me much with calming down, though.";
...
thirdDialogue[1] = "Actually, I was trying to think of a way to cool off.";
...
thirdPortrait[2] = characterSad;
thirdPortrait[3] = objPlayer.sadPortrait;
...
fourthPortrait2[0] = characterSad;
