...
firstPortrait[5] = objPlayer.sadPortrait;
firstPortrait[6] = objPlayer.sadPortrait;
firstPortrait[7] = characterPortrait;
firstPortrait[8] = objPlayer.sadPortrait;
...
secondPortrait[5] = objPlayer.sadPortrait;
...
thirdPortrait[4] = objPlayer.sadPortrait;
thirdPortrait[5] = characterPortrait;
thirdPortrait[6] = objPlayer.sadPortrait;
thirdPortrait[7] = objPlayer.sadPortrait;
thirdPortrait[8] = objPlayer.sadPortrait;
...
thirdPortrait1[0] = objPlayer.sadPortrait;
...
fourthDialogue[3] = "Well, that's not good. I know it's harder to regulate tempteratures as dogs get older.";
fourthDialogue[4] =  "Luckily for you, I have something that might help. I'll go grab it."
fourthPortrait[0] = objPlayer.sadPortrait;
fourthPortrait[1] = characterPortrait;
fourthPortrait[2] = characterPortrait;
fourthPortrait[3] = objPlayer.sadPortrait;
